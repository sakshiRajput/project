...
<div class="container">
  <div class="jumbotron">
    <h1 align="center">Kaleva sweets</h1>      
  ...
  <p>Kaleva,  located in heart of Delhi, stocks close to 1000 varieties of sweets, namkeens and other traditional eatables.
   Be it the Bengali Rossogolla, Rajasthani Ghevar, Karachi Halwa or the Mysore Pak, we at Kaleva give you the very best and exotic Indian taste.
    ...
    We are the fourth generation of Agarwals, initially from Bikaner in Rajasthan, presently running   business..</p>    <br><br> 
...
Kaleva's preparation involves the most ethnic way of sweet making using the traditional method while keeping your health as a priority.
    ...
    <br><br>
    <p>Apart from the range of Sweets and Namkeens, we are now in to packaged pickles, traditional Indian ground spices and papads. </p>  
<br>
